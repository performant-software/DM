goog.provide('sc.util.DeferredCollection');
 ...
 */
sc.util.DeferredCollection = function(opt_deferreds) {
    if (opt_deferreds)
 ...
 */
sc.util.DeferredCollection.prototype.add = function(deferred) {
 ...
 */
sc.util.DeferredCollection.prototype.addAll = function(deferreds) {
 ...
 */
sc.util.DeferredCollection.prototype.singleDone = function(callback) {
 ...
 */
sc.util.DeferredCollection.prototype.singleFail = function(callback) {
 ...
 */
sc.util.DeferredCollection.prototype.singleProgress = function(callback) {
 ...
 * @param {function(Array.<jQuery.deferred>, sc.util.DeferredCollection)} callback
 */
sc.util.DeferredCollection.prototype.allResolved = function(callback) {
 ...
 * @param {function(Array.<jQuery.deferred>, sc.util.DeferredCollection)} callback
 */
sc.util.DeferredCollection.prototype.allComplete = function(callback) {
 ...
 * @param {function(Array.<jQuery.deferred>, sc.util.DeferredCollection)} callback
 */
sc.util.DeferredCollection.prototype.allFailed = function(callback) {
 ...
 */
sc.util.DeferredCollection.prototype.areAllComplete = function() {
 ...
 */
sc.util.DeferredCollection.prototype.areAllResolved = function() {
 ...
 */
sc.util.DeferredCollection.prototype.areAllFailed = function() {
 ...
 * @private
 */
sc.util.DeferredCollection.prototype.callAllDoneCallbacks_ = function(scope, args) {
 ...
 * @private
 */
sc.util.DeferredCollection.prototype.callAllFailedCallbacks_ = function(scope, args) {
 ...
 * @private
 */
sc.util.DeferredCollection.prototype.callAllProgressCallbacks_ = function(scope, args) {
 ...
 * @private
 */
sc.util.DeferredCollection.prototype.setupCallbacks_ = function(deferred) {
    var self = this;
