...
// Please do not edit.
goog.addDependency('../../../atb/ClientApp.js', ['atb.ClientApp'], ['atb.events.LinkingModeEntered', 'atb.events.LinkingModeExited', 'atb.ui.Bezel', 'atb.util.ReferenceUtil', 'atb.util.StyleUtil', 'goog.events', 'goog.events.EventTarget', 'goog.fx.dom.FadeIn', 'goog.fx.dom.FadeOut', 'goog.ui.CustomButton', 'goog.ui.KeyboardShortcutHandler', 'goog.ui.Popup', 'jquery.animate_enhanced', 'jquery.jQuery', 'sc.data.Databroker']);
goog.addDependency('../../../atb/Includes.js', ['atb.Includes'], ['atb.ClientApp', 'atb.ui.WindowScaler', 'atb.viewer.CanvasViewer', 'atb.viewer.Finder', 'atb.viewer.TextEditor', 'atb.widgets.MenuUtil', 'goog.dom', 'goog.events']);
...
goog.addDependency('../../../atb/viewer/ResourceListViewer.js', ['atb.viewer.ResourceListViewer'], ['atb.ClientApp', 'atb.util.ReferenceUtil', 'atb.util.StyleUtil', 'atb.viewer.Viewer', 'goog.array', 'goog.dom', 'goog.events', 'goog.ui.ToolbarButton', 'jquery.jQuery']);
