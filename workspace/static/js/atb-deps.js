...
goog.addDependency('../../../atb/Includes.js', ['atb.Includes'], ['atb.ClientApp', 'atb.PassThroughLoginWebService', 'atb.WebService', 'atb.ui.Preferences', 'atb.ui.WindowScaler', 'atb.viewer.CanvasViewer', 'atb.viewer.Editor', 'atb.viewer.Finder', 'atb.viewer.PanelContainer', 'atb.viewer.PanelManager', 'atb.widgets.MenuUtil', 'goog.dom', 'goog.events']);
...
goog.addDependency('../../../atb/start.js', ['atb.start'], ['atb.DMWebService', 'atb.viewer.Editor', 'atb.viewer.PanelContainer', 'atb.viewer.PanelManager', 'atb.widgets.MenuUtil', 'goog.math.Size']);
...
goog.addDependency('../../../atb/viewer/PanelContainer.js', ['atb.viewer.PanelContainer'], ['atb.ClientApp', 'atb.events.ViewerHasEnteredBackground', 'atb.util.ReferenceUtil', 'atb.util.StyleUtil', 'atb.viewer.ResourceListViewer', 'atb.viewer.UndoStack', 'atb.widgets.IMenu', 'atb.widgets.MenuItem', 'atb.widgets.MenuUtil', 'atb.widgets.Toolbar', 'atb.widgets.VerticalToolbar', 'goog.asserts', 'goog.dom', 'goog.dom.DomHelper', 'goog.editor.Field', 'goog.events', 'jquery.jQuery']);
...
goog.addDependency('../../../atb/viewer/ResourceViewer.js', ['atb.viewer.ResourceViewer'], ['atb.ClientApp', 'atb.DMWebService', 'atb.resource.Image', 'atb.util.ReferenceUtil', 'atb.viewer.CanvasThumbnail', 'goog.math.Size', 'jquery.jQuery']);
...
goog.addDependency('../../../atb/widgets/ExclusiveGrouping.js', ['atb.widgets.ExclusiveGrouping'], ['atb.util.ReferenceUtil']);
...
goog.addDependency('../../../sc/data/Databroker.js', ['sc.data.Databroker'], ['goog.Uri', 'goog.string', 'goog.structs.Map', 'goog.structs.Set', 'jquery.rdfquery', 'sc.data.Quad', 'sc.data.QuadStore', 'sc.data.Resource', 'sc.util.DefaultDict', 'sc.util.DeferredCollection', 'sc.util.Namespaces']);
...
goog.addDependency('../../../sc/data/Resource.js', ['sc.data.Resource'], ['goog.structs.Set', 'jquery.jQuery', 'sc.data.Quad', 'sc.util.Namespaces']);
