goog.provide("atb.widgets.VerticalToolbar");

/**
 * @fileoverview atb.widgets.VerticalToolbar provides a Vertical "toolbar" implementation of atb.widgets.IMenu, based around the google closure library's goog.ui.Toolbar.
 *
 * @author John O'Meara
**/
...
goog.require("atb.widgets.IMenu");//LOL!
/**
...
atb.widgets.VerticalToolbar = function(set_targetDiv, opt_initialMenuItems, opt_menu_options)
{
	...
	//atb.util.StyleUtil.includeStyleSheetOnce(cssPath + "/atb/widgets/VerticalToolbar.css");
	//atb.util.StyleUtil.includeStyleSheetOnceFromRoot(this.menu_options["cssRoot"], "/atb/widgets/VerticalToolbar.css");
...
goog.inherits(atb.widgets.VerticalToolbar, atb.widgets.IMenu);

atb.widgets.VerticalToolbar.prototype.testHack = function(usingDiv, bVerticalToolbar)
{
 ...
 * @inheritDoc
**/
atb.widgets.VerticalToolbar.prototype._onShowMenu = function()
{
	this._onRepaint();
	//orlolupaatelol..?^
 ...
 * @inheritDoc
**/
atb.widgets.VerticalToolbar.prototype._onHideMenu = function()
{
 ...
 * @inheritDoc
**/
atb.widgets.VerticalToolbar.prototype._onRepaint = function()
{
 ...
 * @inheritDoc
**/
atb.widgets.VerticalToolbar.prototype._addMenuItem = function(menuItem)
{
	/*
...
/*
atb.widgets.VerticalToolbar.prototype._makeToolbarHelper = function(usingDiv, bVerticalToolbar)
{
