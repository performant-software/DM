...
goog.addDependency('../../../dm/viewer/TextEditor.js', ['dm.viewer.TextEditor'], ['dm.Util', 'dm.events.ResourceClick', 'dm.events.ResourceModified', 'dm.util.ReferenceUtil', 'dm.util.Set', 'dm.util.StyleUtil', 'dm.viewer.TextEditorAnnotate', 'dm.viewer.TextEditorProperties', 'dm.viewer.Viewer', 'dm.widgets.DialogWidget', 'dm.widgets.ForegroundMenuDisplayer', 'dm.widgets.GlassPane', 'dm.widgets.IMenu', 'dm.widgets.MenuItem', 'dm.widgets.MenuUtil', 'dm.widgets.Toolbar', 'goog.asserts', 'goog.cssom.iframe.style', 'goog.dom', 'goog.dom.DomHelper', 'goog.dom.classes', 'goog.editor.Command', 'goog.editor.Field', 'goog.editor.plugins.BasicTextFormatter', 'goog.editor.plugins.EnterHandler', 'goog.editor.plugins.HeaderFormatter', 'goog.editor.plugins.LinkBubble', 'goog.editor.plugins.LinkDialogPlugin', 'goog.editor.plugins.ListTabHandler', 'goog.editor.plugins.LoremIpsum', 'goog.editor.plugins.RemoveFormatting', 'goog.editor.plugins.SpacesTabHandler', 'goog.editor.plugins.UndoRedo', 'goog.string', 'goog.ui.ToolbarSeparator', 'goog.ui.editor.DefaultToolbar', 'goog.ui.editor.ToolbarController'], false);
