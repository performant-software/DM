goog.provide('dm.viewer.TextEditorProperties');
...
/**
 * @param editor {dm.viewer.TextEditor}
 */
dm.viewer.TextEditorProperties = function (editor) {
    this.editor = editor;
...
dm.viewer.TextEditorProperties.prototype.render = function (div) {
    div.appendChild(this.div);
};

dm.viewer.TextEditorProperties.prototype.renderInternal = function () {
...
dm.viewer.TextEditorProperties.prototype.renderPurpose = function () {
...
dm.viewer.TextEditorProperties.prototype.renderDoneButton = function () {
...
dm.viewer.TextEditorProperties.prototype.purposeValuesByText = 
{
    'Annotation': 'anno',
    'Transcription': 'trans',
    'Other': 'other'
...
dm.viewer.TextEditorProperties.prototype.purposeTextsByValue = {
    'anno': 'Annotation',
    'trans': 'Transcription',
    'other': 'Other'
};

dm.viewer.TextEditorProperties.prototype.purposeTextToValue = function (text) {
    return this.purposeValuesByText[text];
};

dm.viewer.TextEditorProperties.prototype.purposeValueToText = function (value) {
    return this.purposeTextsByValue[value];
};

dm.viewer.TextEditorProperties.prototype.getUnescapedProperties = function () {
    var properties = {};
...
dm.viewer.TextEditorProperties.prototype.setProperties = function (properties) {
