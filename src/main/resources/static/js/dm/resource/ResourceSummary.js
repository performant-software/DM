//ResourceSummary
goog.provide('dm.resource.ResourceSummary');
...
dm.resource.TARGET_VIEW = 'target';
dm.resource.BODY_VIEW = 'body';
dm.resource.RESOURCE_VIEW = 'resource';


/**
 * dm.resource.ResourceSummary
 *
 ...
 *
 * @param uri {string}
 * @param viewer {dm.viewer.Viewer} the click handler will be called with
 * this scope
 * @param clientApp {dm.ClientApp}
 * @param opt_domHelper {!goog.dom.DomHelper}
 * @param opt_styleOptions {!Object} defaults to dm.resource.ResourceSummary.DEFAULT_STYLE_OPTIONS
 */
dm.resource.ResourceSummary = function (uri, viewer, clientApp, opt_domHelper, opt_styleOptions) {
    ...
    this.styleOptions = jQuery.extend(
        goog.object.clone(dm.resource.ResourceSummary.DEFAULT_STYLE_OPTIONS),
        opt_styleOptions
    );
};
goog.inherits(dm.resource.ResourceSummary, goog.events.EventTarget);

/**
 * Renders the panel selection controls in the top right corner
 */
dm.resource.ResourceSummary.prototype.renderPanelCtrls = function () {
 ...
 */
dm.resource.ResourceSummary.DEFAULT_STYLE_OPTIONS = {
    showControls: true,
    titleOnly: false
};
 ...
 */
dm.resource.ResourceSummary.prototype.render = function (opt_div) {
...
dm.resource.ResourceSummary.prototype.getElement = function() {
    return this.outerDiv;
};
 ...
 */
dm.resource.ResourceSummary.prototype.handleClick = function (e) {
    e.stopPropagation();
...
dm.resource.ResourceSummary.prototype.deleteClickHandler = function(event) {
 ...
 */
dm.resource.ResourceSummary.prototype.enableDelete = function () {
 ...
 */
dm.resource.ResourceSummary.prototype.disableDelete = function () {
 ...
 * @param other {Object}
 */
dm.resource.ResourceSummary.prototype.equals = function (other) {
    if (!other)
        return false;
 ...
 */
dm.resource.ResourceSummary.prototype.setTooltip = function (tooltipText) {
 ...
 */
dm.resource.ResourceSummary.prototype.toggleSelected = function () {
 ...
 */
dm.resource.ResourceSummary.prototype.setSelected = function (selected) {
    if (selected) {
 ...
 * @param view {string}
 */
dm.resource.ResourceSummary.prototype.setView = function (view) {
    this.view = view;
};
 ...
 * @return {string}
 */
dm.resource.ResourceSummary.prototype.getView = function () {
    return this.view;
};

dm.resource.ResourceSummary.prototype.getSortTitle = function() {
 ...
 * @param summaryA {dm.resource.ResourceSummary}
 * @param summaryB {dm.resource.ResourceSummary}
 */
dm.resource.ResourceSummary.sortByTitle = function (summaryA, summaryB) {
