goog.provide('dm.resource.TextHighlightSummary');

goog.require('dm.resource.ResourceSummary');

/**
 * dm.resource.TextHighlightSummary
 *
 ...
 * @param resource {dm.resource.TextHighlightResource}
 * @param div {HTML Element}
 */
dm.resource.TextHighlightSummary = function (uri, viewer, clientApp, opt_domHelper, opt_styleOptions) {
...
goog.inherits(dm.resource.TextHighlightSummary, dm.resource.ResourceSummary);

dm.resource.TextHighlightSummary.prototype.type = 'Highlight';
 ...
 */
dm.resource.TextHighlightSummary.prototype.decorate = function (opt_label) {
...
dm.resource.TextHighlightSummary.prototype.determineCutoff = function (text, limit) {
...
dm.resource.TextHighlightSummary.prototype.getSortTitle = function() {
