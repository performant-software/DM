goog.provide('dm.RepoBrowserItem');

/**
 * UI for an entry in the dm.RepoBrowser
 *
 * @constructor
 * @param browser {dm.RepoBrowser} The parent RepoBrowser.
 */
dm.RepoBrowserItem = function(repoBrowser) {
 ...
 * @param {Element} div
 */
dm.RepoBrowserItem.prototype.decorate = function(div) {
    this.rootDiv = div;
    var $div = jQuery(div);
 ...
 * @return {Element}
 */
dm.RepoBrowserItem.prototype.render = function(opt_div) {
 ...
 */
dm.RepoBrowserItem.prototype.getElement = function() {
    return this.rootDiv;
};
 ...
 */
dm.RepoBrowserItem.prototype.setTitle = function(title, opt_temp) {
 ...
 * @return {string}
 */
dm.RepoBrowserItem.prototype.getTitle = function() {
    return this.title;
};
 ...
 */
dm.RepoBrowserItem.prototype.bind = function(eventType, b, c) {
...
dm.RepoBrowserItem.prototype.on = dm.RepoBrowserItem.prototype.bind;
 ...
 * @param {Object} b
 */
dm.RepoBrowserItem.prototype.unbind = function(a, b) {
    this.complainIfNotYetRendered();

    jQuery(this.rootDiv).unbind(a, b);
};
dm.RepoBrowserItem.prototype.off = dm.RepoBrowserItem.prototype.unbind;

/**
 * Displays a network error icon in the browser item
 * @param {string} opt_errorTooltip A description of the error.
 */
dm.RepoBrowserItem.prototype.indicateNetworkError = function(opt_errorTooltip) {
 ...
 * @param handler {function(jQuery.event, dm.RepoBrowserItem)}
 */
dm.RepoBrowserItem.prototype.showAddButton = function(handler) {
    var self = this;
 ...
 * @param uri {string}
 */
dm.RepoBrowserItem.prototype.setUri = function(uri) {
    this.uri = uri;
};
 ...
 * @return {string}
 */
dm.RepoBrowserItem.prototype.getUri = function() {
    return this.uri;
};
 ...
 * @param type {string}
 */
dm.RepoBrowserItem.prototype.setType = function(type) {
    this.type = type;
};
 ...
 * @return {string}
 */
dm.RepoBrowserItem.prototype.getType = function() {
    return this.type;
};

dm.RepoBrowserItem.prototype.setUrisInOrder = function(urisInOrder) {
    this.urisInOrder = urisInOrder;
};

dm.RepoBrowserItem.prototype.getUrisInOrder = function() {
    return this.urisInOrder;
};

dm.RepoBrowserItem.prototype.setCurrentIndex = function(index) {
    this.currentIndex = index;
};

dm.RepoBrowserItem.prototype.getCurrentIndex = function() {
 ...
 */
dm.RepoBrowserItem.prototype.complainIfNotYetRendered = function(opt_loudly, opt_message) {
 ...
 * @param a {dm.RepoBrowserItem}
 * @param b {dm.RepoBrowserItem}
 */
dm.RepoBrowserItem.sortByTitle = function(a, b) {
