goog.provide('dm.util.OrderedSet');
 ...
 */
dm.util.OrderedSet = function (opt_values, opt_uidFunction) {
...
goog.inherits(dm.util.OrderedSet, goog.structs.Set);

/**
 * Returns a uid key for any element
 */
dm.util.OrderedSet.prototype.getKey_ = function (element) {
 ...
 * @return {Number}
 */
dm.util.OrderedSet.prototype.getIndexOfElement = function (element) {
...
dm.util.OrderedSet.prototype.indexOf = dm.util.OrderedSet.prototype.getIndexOfElement;

/**
 * @inheritdoc
 */
dm.util.OrderedSet.prototype.contains = function (element) {
 ...
 * @param element {*}
 */
dm.util.OrderedSet.prototype.add = function (element) {
 ...
 */
dm.util.OrderedSet.prototype.remove = function (element) {
    var key = this.getKey_(element);
 ...
 * Clears all elements
 */
dm.util.OrderedSet.prototype.clear = function () {
    this.keysInOrder_ = [];
 ...
 * @return {Array}
 */
dm.util.OrderedSet.prototype.getValues = function () {
    var values = [];
 ...
 * O(n)
 *
 * @return {dm.util.OrderedSet}
 */
dm.util.OrderedSet.prototype.clone = function () {
    return new dm.util.OrderedSet(this.getValues());
};
 ...
 * @return {Boolean}
 */
dm.util.OrderedSet.prototype.equals = function (col) {
    return goog.structs.Set.prototype.equals.call(this, col) && goog.array.equals(this.keysInOrder_, col.keysInOrder_);
};

dm.util.OrderedSet.prototype.__iterator__ = function (opt_keys) {
    var i = 0;
