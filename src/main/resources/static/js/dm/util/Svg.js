 ...
 */
dm.util.svg.raphaelElementToSVG = function(node) {
    var escapeXML = dm.data.NamespaceManager.escapeForXml;
 ...
 */
dm.util.svg.parseAttrsFromString = function(str) {
    str = dm.data.NamespaceManager.unescapeFromXml(str);
