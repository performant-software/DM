 ...
 * @return {Number}
 */
dm.util.stats.mean = function (list) {
    var sum = 0;
 ...
 * @return {Number}
 */
dm.util.stats.standardDeviation = function (list) {
    var mean = dm.util.stats.mean(list);
 ...
 * @return {Number}
 */
dm.util.stats.median = function (list, opt_allowSortInPlace) {
    var sorted;
...
dm.util.stats.zScore = function (value, mean, standardDeviation) {
