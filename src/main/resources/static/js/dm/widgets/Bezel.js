 ...
 */
dm.widgets.Bezel = function (cssClass, opt_size, opt_parentElement) {
...
goog.inherits(dm.widgets.Bezel, goog.Disposable);

dm.widgets.Bezel.prototype.render = function () {
    if (this.rendered) {
        return;
    }
 ...
 */
dm.widgets.Bezel.prototype.show = function (opt_centerOnPosition) {
    if (! this.rendered) {
        this.render();
    }
...
dm.widgets.Bezel.prototype.hide = function () {
    jQuery(this.div).fadeOut(1200, dm.Util.scopeAsyncHandler(this.dispose, this));
};

dm.widgets.Bezel.prototype.disposeInternal = function () {
