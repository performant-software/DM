...
dm.widgets.IMenu = function()
{
	...
	**/
	...
	/**
	 * Our menuItems.
	 * @type{Array.<dm.widgets.MenuItem>}
	 * @private
	**/
	this.items = [];
...
/*
//Too complex for now:
dm.widgets.IMenu.prototype.setActiveGroupItem=function(groupName, activeMenuItem)
{
 ...
 * @param {Array.<dm.widgets.MenuItem>} addTheseItems An array of menuItems to sequentially add to this menu.
**/
dm.widgets.IMenu.prototype.addItems = function(addTheseItems)
{
...
**/
dm.widgets.IMenu.prototype.setContext = function(set_contextObject)
{
...
**/
dm.widgets.IMenu.prototype.getContext = function()
{
 ...
 * @param {dm.widgets.MenuItem} menuItem The menuItem to be added.
**/
dm.widgets.IMenu.prototype.addItem = function(menuItem)
{
	var self = this;
...
**/
dm.widgets.IMenu.prototype.setLocation = function(setX, setY)
{
	this.x=setX;
	this.y=setY;
	this._onRepaint();
...
//Alias:
dm.widgets.IMenu.prototype.setPosition = dm.widgets.IMenu.prototype.setLocation;

/**
 * controls the visibility of the menu.
 * @param {boolean} bVisible - to show (true), or hide (false) the menu.
**/
dm.widgets.IMenu.prototype.setVisible = function(bVisible) {
...
**/
dm.widgets.IMenu.prototype.isVisible = function()
{
...
**/
dm.widgets.IMenu.prototype.show = function()
{
...
**/
dm.widgets.IMenu.prototype.hide = function()
{
	if (this.isVisible())
	{
 ...
 * @param {number} setY The y-Coordinate
**/
dm.widgets.IMenu.prototype.invokeMenu = function(withContext, atX, atY)
{
	//first hide the menu
	this.hide();
 ...
 * @param {number} setY The y-Coordinate
**/
dm.widgets.IMenu.prototype.showMenuAt = function(atX, atY)
{
	this.hide();
...
**/
dm.widgets.IMenu.prototype.getX = function()
{
	return this.x;
};
...
**/
dm.widgets.IMenu.prototype.getY = function()
{
	return this.y;
};
 ...
 * @protected
**/
dm.widgets.IMenu.prototype._addMenuItem = function(menuItem)
{
	//TODO: override me
};
 ...
 * @protected
**/
dm.widgets.IMenu.prototype._onShowMenu = function()
{
	//TODO: override me
};
 ...
 * @protected
**/
dm.widgets.IMenu.prototype._onHideMenu = function()
{
	//TODO: override me
};
 ...
 * @protected
**/
dm.widgets.IMenu.prototype._onRepaint = function()
{
	//TODO: override me
};
 ...
 * @protected
**/
dm.widgets.IMenu.prototype.createMenuActionEvent = function(menuItem)
{
	//return new dm.widgets.MenuActionEvent(this.getViewerHack(), this, menuItem, this.getContext());
	//return new dm.widgets.MenuActionEvent(this.setActivePane(), this, menuItem, this.getContext());
	return new dm.widgets.MenuActionEvent(
 ...
 * @protected
**/
dm.widgets.IMenu.prototype.raiseMenuActionEvent=function(menuItem)
{
...
//dm.widgets.IMenu.prototype.setViewerHack = function(set_viewer)
//dm.widgets.IMenu.prototype.setActivePane = function(set_viewer)
dm.widgets.IMenu.prototype.setActivePane = function(set_pane)
{
	//^LOLZ!
...
dm.widgets.IMenu.prototype.getActivePane = function()//getViewerHack = function()
{//hack-private:
	//return this.activeViewer;
	return this.activePane;
};

dm.widgets.IMenu.prototype.addMenuItemListener = function(listenerFunc)
{
