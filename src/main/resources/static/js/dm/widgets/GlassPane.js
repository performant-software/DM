goog.provide("dm.widgets.GlassPane");
/**
...
**/
dm.widgets.GlassPane = function(opt_domHelper, opt_options)
{
	//initialize our dom helper field:
	this.bVisible = false;
	
	var domHelper = dm.util.ReferenceUtil.applyDefaultValue(opt_domHelper, null);//HACK
	if (domHelper === null)
	{
	...
	opt_options = dm.util.ReferenceUtil.applyDefaultValue(opt_options, {});
	opt_options = dm.util.ReferenceUtil.mergeOptions(opt_options, this.DefaultGlassPaneOptions);
...
**/
dm.widgets.GlassPane.prototype.listen = function(eventName, callback)
{
 ...
 * @param {function} callback The callback to be called when the event fires.
**/
dm.widgets.GlassPane.prototype.listenOnce = function(eventName, callback)
{
...
**/
dm.widgets.GlassPane.prototype.appendChild = function(domNode)
{
 ...
 * shows us.
**/
dm.widgets.GlassPane.prototype.show = function()
{
	this.bVisible = true;
...
dm.widgets.GlassPane.prototype.isVisible = function()
{
	return this.bVisible;
};
dm.widgets.GlassPane.prototype.requestFocus = function()
{
	//jQuery(this.glassPaneEffect).focus();
...
//dm.widgets.GlassPane.prototype.getGlassEffectPane=function()
dm.widgets.GlassPane.prototype.getGlassPane = function()
{
	return this.glassPane;
};
dm.widgets.GlassPane.prototype.getGlassPaneEffect=function()
{
 ...
 * hides us.
**/
dm.widgets.GlassPane.prototype.hide = function()
{
...
**/
dm.widgets.GlassPane.prototype.createChildWithClasses = function(elementNodeName, opt_cssClasses)
{
	var cssClasses = dm.util.ReferenceUtil.applyDefaultValue(opt_cssClasses, null);
...
**/
dm.widgets.GlassPane.prototype.getBodyTag_ = function()
{
...
**/
dm.widgets.GlassPane.prototype.doAnimation_ = function(animName, opt_complete_callback)
{
	opt_complete_callback = dm.util.ReferenceUtil.applyDefaultValue(opt_complete_callback, null);
	
	var animInfo = this.getOption_(animName);
	
	var duration = dm.util.ReferenceUtil.applyDefaultValue(animInfo["duration"], 0);
	var easingMethod = dm.util.ReferenceUtil.applyDefaultValue(animInfo["easing"], null);
	
	if (!dm.util.LangUtil.forceBoolean(animInfo["bEnabled"], true))
	{
	...
	var toStyle = dm.util.ReferenceUtil.mergeOptions(animInfo["toStyle"], {});
...
**/
dm.widgets.GlassPane.prototype.getOption_ = function(/* ... arguments*/)
{
	var args = [];
...
**/
dm.widgets.GlassPane.prototype.DefaultGlassPaneOptions = {
...
dm.widgets.GlassPane.prototype.getChildContainer = function()
{
