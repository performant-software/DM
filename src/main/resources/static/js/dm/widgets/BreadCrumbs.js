goog.provide('dm.widgets.BreadCrumbs');
 ...
 */
dm.widgets.BreadCrumbs = function (opt_domHelper) {
 ...
 */
dm.widgets.BreadCrumbs.prototype.decorate = function (div) {
    this.rootDiv = div;
    var $div = jQuery(div);
 ...
 */
dm.widgets.BreadCrumbs.prototype.render = function (div) {
 ...
 */
dm.widgets.BreadCrumbs.prototype.push = function (text, clickHandler, opt_tooltip) {
 ...
 */
dm.widgets.BreadCrumbs.prototype.pop = function () {
    if (! this.canPop()) {
 ...
 */
dm.widgets.BreadCrumbs.prototype.canPop = function () {
 ...
 */
dm.widgets.BreadCrumbs.prototype.getNumItems = function () {
 ...
 */
dm.widgets.BreadCrumbs.prototype.onSizeChange = function () {
    var self = this;
