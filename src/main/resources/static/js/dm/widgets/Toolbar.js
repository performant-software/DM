goog.provide("dm.widgets.Toolbar");

/**
 * @fileoverview dm.widgets.Toolbar provides a "toolbar" implementation of dm.widgets.IMenu, based around the google closure library's goog.ui.Toolbar.
 *
 * @author John O'Meara
**/
...
**/
dm.widgets.Toolbar = function(set_targetDiv, opt_initialMenuItems)
{
	...
	this.buttonsByName = new dm.util.Map();
...
goog.inherits(dm.widgets.Toolbar, dm.widgets.IMenu);

/**
 * @inheritDoc
**/
dm.widgets.Toolbar.prototype._onShowMenu = function()
{
	this._onRepaint();
	//orlolupaatelol..?^
 ...
 * @inheritDoc
**/
dm.widgets.Toolbar.prototype._onHideMenu = function()
{
 ...
 * @inheritDoc
**/
dm.widgets.Toolbar.prototype._onRepaint = function()
{
 ...
 * @inheritDoc
**/
dm.widgets.Toolbar.prototype._addMenuItem = function(menuItem)
{
	/*
...
dm.widgets.Toolbar.prototype.setWidthHack = function(newWidth)
{
	this.baseDiv.style.width = ""+newWidth+"px";
};

dm.widgets.Toolbar.prototype.setMenuItemSelected_hack = function(menuItem, bSelected)
{
...
dm.widgets.Toolbar.prototype.isMenuItemSelected = function(menuItem)
{
	var menuItemName = menuItem.getName();
	var button = this.buttonsByName.get(menuItemName);
	if (button === null)
...
dm.widgets.Toolbar.prototype.selectButtonByName = function(buttonName) //hack to allow us to set the active button visually
{
	var button = this.buttonsByName.get(buttonName);
	if (button === null)
	{
