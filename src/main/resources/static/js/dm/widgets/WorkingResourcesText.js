goog.provide('dm.widgets.WorkingResourcesText');

goog.require('dm.widgets.WorkingResourcesItem');

dm.widgets.WorkingResourcesText = function(databroker, uri, opt_domHelper) {
    dm.widgets.WorkingResourcesItem.call(this, databroker, uri, opt_domHelper);
};
goog.inherits(dm.widgets.WorkingResourcesText, dm.widgets.WorkingResourcesItem);

dm.widgets.WorkingResourcesText.prototype.setupLayout_ = function() {
