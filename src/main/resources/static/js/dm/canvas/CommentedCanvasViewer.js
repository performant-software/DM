goog.provide('dm.canvas.CommentedCanvasViewer');

goog.require('dm.canvas.CanvasViewer');
goog.require('dm.CommentViewer');
 ...
 *
 * @constructor
 * @extends {dm.canvas.CanvasViewer}
 * @param {Object} options Optional configuration information.
 */
dm.canvas.CommentedCanvasViewer = function(options) {
    dm.canvas.CanvasViewer.call(this, options);
    
    this.setupPopup();
};
goog.inherits(dm.canvas.CommentedCanvasViewer, dm.canvas.CanvasViewer);

/**
 * Default options for the canvas which can be overridden in the constructor.
 */
dm.canvas.CommentedCanvasViewer.prototype.options =
jQuery.extend(dm.canvas.CanvasViewer.prototype.options, {
    'popupWidth': 300,
    'popupHeight': 250,
    'popupHideDelay': 500,
    'popupShowDelay': 300
 ...
 * @protected
 */
dm.canvas.CommentedCanvasViewer.prototype.setupPopup = function() {
    ...
    this.commentViewer = new dm.CommentViewer(this.databroker);
 ...
 */
dm.canvas.CommentedCanvasViewer.prototype.showComments =
 ...
 * comments popup should be shown.
 */
dm.canvas.CommentedCanvasViewer.prototype.calculatePopupCoords =
function(pageCoords) {
 ...
 * comments popup should be shown.
 */
dm.canvas.CommentedCanvasViewer.prototype.delayedShowComments =
function(uri, pagePosition) {
    var self = this;
 ...
 */
dm.canvas.CommentedCanvasViewer.prototype.hideComments = function() {
 ...
 * or the popup.
 */
dm.canvas.CommentedCanvasViewer.prototype.maybeHideComments = function() {
 ...
 */
dm.canvas.CommentedCanvasViewer.prototype.delayedMaybeHideComments =
function() {
    var self = this;
    window.setTimeout(function() {
 ...
 */
dm.canvas.CommentedCanvasViewer.prototype.handleMouseover = function(event) {
 ...
 * @param {Event} event The event fired.
 */
dm.canvas.CommentedCanvasViewer.prototype.handleMouseout = function(event) {
