goog.provide('dm.canvas.PanZoomGesturesControl');
 ...
 *
 * @param {dm.canvas.CanvasViewport} viewport The canvas viewport to
 * control.
 */
dm.canvas.PanZoomGesturesControl = function(viewport) {
...
goog.inherits(dm.canvas.PanZoomGesturesControl, dm.canvas.Control);

dm.canvas.PanZoomGesturesControl.prototype.controlName = 'PanZoomGesturesControl';

/**
 * @inheritDoc
 */
dm.canvas.PanZoomGesturesControl.prototype.activate = function() {
 ...
 * @inheritDoc
 */
dm.canvas.PanZoomGesturesControl.prototype.deactivate = function() {
 ...
 * @this {dm.canvas.PanZoomGesturesControl}
 * @param {Event} event The jQuery event fired.
 * @return {boolean} False to stop propagation.
 */
dm.canvas.PanZoomGesturesControl.prototype.handleMousewheel =
...
dm.canvas.PanZoomGesturesControl.prototype.handleMousedown = function(opts) {
    var event = opts.e;
...
dm.canvas.PanZoomGesturesControl.prototype.handleMousemove = function(opts) {
...
dm.canvas.PanZoomGesturesControl.prototype.handleMouseup = function(opts) {
    var event = opts.e;
 ...
 * @param {Event} event The jQuery event fired.
 */
dm.canvas.PanZoomGesturesControl.prototype.handleDblclick = function(event) {
