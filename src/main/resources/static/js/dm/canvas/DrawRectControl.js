goog.provide('dm.canvas.DrawRectControl');
 ...
 */
dm.canvas.DrawRectControl = function(viewport, databroker) {
...
goog.inherits(dm.canvas.DrawRectControl, dm.canvas.DrawFeatureControl);

dm.canvas.DrawRectControl.prototype.controlName = 'DrawRectControl';

/**
 * @inheritDoc
 */
dm.canvas.DrawRectControl.prototype.activate = function() {
 ...
 * @inheritDoc
 */
dm.canvas.DrawRectControl.prototype.deactivate = function() {
 ...
 */
dm.canvas.DrawRectControl.prototype.handleMousedown = function(opts) {
    var event = opts.e;
 ...
 * @param {Event} event The jQuery event fired.
 */
dm.canvas.DrawRectControl.prototype.handleMousemove = function(opts) {
    var event = opts.e;
 ...
 * @param {Event} event The jQuery event fired.
 */
dm.canvas.DrawRectControl.prototype.handleMouseup = function(opts) {
    var event = opts.e;
