goog.provide('dm.canvas.ImageChoicePicker');

goog.require('goog.ui.Button');
goog.require('goog.ui.CustomButton');
goog.require('goog.structs.Set');

dm.canvas.ImageChoicePicker = function(button, databroker, imageWidth) {
...
dm.canvas.ImageChoicePicker.prototype.getElement = function() {
    return this.baseDiv;
};

dm.canvas.ImageChoicePicker.prototype.render = function(div) {
    div.appendChild(this.baseDiv);
};

dm.canvas.ImageChoicePicker.prototype.clear = function() {
    jQuery(this.imagesDiv).empty();
    this.uris.clear();
    this.button.setEnabled(false);
};

dm.canvas.ImageChoicePicker.prototype.addImage = function(uri, choiceHandler) {
    this.uris.add(uri);
...
dm.canvas.ImageChoicePicker.prototype.showChoices = function() {
    var self = this;
...
dm.canvas.ImageChoicePicker.prototype.hideChoices = function() {
    var self = this;
...
dm.canvas.ImageChoicePicker.prototype.handleGlassPaneClick = function(event) {
