 ...
 */
dm.BreadCrumbs = function (opt_doc) {
 ...
 */
dm.BreadCrumbs.prototype.decorate = function (div) {
    this.rootDiv = div;
    var $div = jQuery(div);
 ...
 * @return {Element}
 */
dm.BreadCrumbs.prototype.render = function (opt_div) {
 ...
 * @return {Element}
 */
dm.BreadCrumbs.prototype.getElement = function () {
    return this.rootDiv;
};
 ...
 */
dm.BreadCrumbs.prototype.push = function (text, clickHandler, opt_tooltip) {
 ...
 */
dm.BreadCrumbs.prototype.pop = function () {
    if (! this.canPop()) {
 ...
 */
dm.BreadCrumbs.prototype.canPop = function () {
 ...
 */
dm.BreadCrumbs.prototype.getNumItems = function () {
 ...
 */
dm.BreadCrumbs.prototype.onSizeChange = function () {
    var self = this;
