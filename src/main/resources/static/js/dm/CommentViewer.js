 ...
 *
 * @param {dm.data.Databroker} databroker The databroker from which annotation
 * data should be queried.
 * @param {(Object|null|undefined)} options Options to apply to this Comment
 * Comment Viewer.
 */
dm.CommentViewer = function(databroker, options) {
...
goog.inherits(dm.CommentViewer, goog.events.EventTarget);

/**
 * The types of annotation bodies which should be rendered as comments.
 */
dm.CommentViewer.COMMENT_BODY_TYPES = ['media-types:text/html'];

/**
 * The default options.
 */
dm.CommentViewer.prototype.options = {
    'doc': window.document
};
 ...
 * appended.
 */
dm.CommentViewer.prototype.render = function(div) {
 ...
 */
dm.CommentViewer.prototype.getElement = function() {
    return this.div;
};
 ...
 */
dm.CommentViewer.prototype.clear = function() {
 ...
 */
dm.CommentViewer.prototype.addOrModifyComment = function(uri) {
 ...
 */
dm.CommentViewer.prototype.isCommentRendered = function(uri) {
 ...
 * @return {dm.CommentViewer} This.
 */
dm.CommentViewer.prototype.setUri = function(uri) {
    this.uri = uri;
    
    this.clear();
    
    var withBodyResource = function(resource) {
        if (resource.hasAnyType(dm.CommentViewer.COMMENT_BODY_TYPES)) {
