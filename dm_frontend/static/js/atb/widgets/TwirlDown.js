 ...
 * defaults to false
 */
atb.widgets.TwirlDown = function (header, content, button, opt_opened) {
    this.header = header;
...
atb.widgets.TwirlDown.prototype.open = function () {
    this.isOpen = true;
...
atb.widgets.TwirlDown.prototype.close = function () {
    this.isOpen = false;
...
atb.widgets.TwirlDown.prototype.toggle = function () {
    if (this.isOpen) {
        this.close();
    }
    else {
...
atb.widgets.TwirlDown.prototype.setExpanded = function (expanded) {
    if (expanded) {
        this.open();
    }
    else {
 ...
 * @return {Element}
 */
atb.widgets.TwirlDown.prototype.getHeaderElement = function () {
    return this.header;
};
 ...
 * @return {Element}
 */
atb.widgets.TwirlDown.prototype.getContentElement = function () {
    return this.content;
};
 ...
 * @return {Element}
 */
atb.widgets.TwirlDown.prototype.getButtonElement = function () {
    return this.button;
};
 ...
 * @return {boolean}
 */
atb.widgets.TwirlDown.prototype.isOpen = function () {
    return this.isOpen;
};

atb.widgets.TwirlDown.prototype.setAnimationDuration = function (duration) {
