...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('semantic_store_projectpermission', ['user_id', 'identifier', 'permission'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectPermission', fields ['user', 'identifier', 'permission']
        db.delete_unique('semantic_store_projectpermission', ['user_id', 'identifier', 'permission'])
    ...
    models = {
        ...
        'semantic_store.projectpermission': {
            'Meta': {'unique_together': "(('user', 'identifier', 'permission'),)", 'object_name': 'ProjectPermission'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
